...
const Checkbox: React.FC<IProps> = ({title, size, color, checkedColor, initiallyChecked, onPress}) => {
    ...
    <View style={styles.checkbox}>
        <View style={styles.checkboxChild}>
            <Pressable onPress={handleOnPress}>
                {checked && <Image source={require('./check.png')} style={styles.check as ImageStyle}/>}
                <View style={styles.checkContainer} />
            </Pressable>
            <CustomText size='small' style={styles.title}>{title}</CustomText>
        </View>
    </View>
  )
}
