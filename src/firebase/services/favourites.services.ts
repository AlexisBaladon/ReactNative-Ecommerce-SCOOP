...
export const addItemFavourites = async (userId: User['userId'], item: DtItem): Promise<Error | any> => {
...
export const removeItemFavourites = async (userId: User['userId'], itemId: DtItem['id']): Promise<Error | any> => {
    try {
